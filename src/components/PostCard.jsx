...
const PostCard = ({userId, postId, status, uImg, uName, currentPostUser, currentPostContent, postContent, liked, likes, likePost, bookmarked, bookmarks, bookmarkPost, deletePost, datetime, openModal}) => {
